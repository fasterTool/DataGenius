...
import cn.ly.common.datasource.service.query.build.QueryTreeBuilder;
...
public abstract class CRUDGeneratorBuilder extends AbstractSqlGeneratorBuilder implements ISqlGenerator {
    ...
    public String insertSql(Object obj) {
        return insertSql(Arrays.asList(obj), CRUDUtils.getTableName(obj), null);
    }


    @Override
    public String insertSqlUseUid(Object obj) {
        return insertSql(Arrays.asList(obj), CRUDUtils.getTableName(obj), true, null);
    }
    ...
    @Override
    public String insertSqlUseUid(Object obj, String... ignoreFields) {
        return insertSql(Arrays.asList(obj), CRUDUtils.getTableName(obj), true, false, ignoreFields);
    }

    @Override
    public String insertSqlExcludeId(Object obj, String... ignoreFields) {
        return insertSql(Arrays.asList(obj), CRUDUtils.getTableName(obj), true, true, ignoreFields);
    }
    ...
    public String insertSql(Object obj, String tableName, String... ignoreFields) {
        return insertSql(Arrays.asList(obj), tableName, false, ignoreFields);
    }

    @Override
    public String insertSql(List list, String tableName, boolean withUid, String... ignoreFields) {
        return insertSql(list, tableName, withUid, false, ignoreFields);
    }

    public String insertSql(List list, String tableName, boolean withUid, boolean excludeId, String... ignoreFields) {
        ...
        for (Field field : list.get(0).getClass().getDeclaredFields()) {
            ...
            if (field.getAnnotation(Ignore.class) == null && !ignoreField(field.getName(), ignoreFields)) {
                ...
                for (int index = 0; index < list.size(); index++) {
                    valueSb.get(index).append("'").append(generateFieldValue(field, list.get(index), withUid)).append("',");
                }
            }
        }
