...
public abstract class AbstractSqlGeneratorBuilder implements ISqlGenerator {
    ...
    String generateFieldValue(Field field, Object obj, boolean withUid, UidGenerator uidGenerator) {
        if (field.getDeclaredAnnotation(Id.class) != null) return generateIdValue(field, obj, withUid,uidGenerator);
        return earnFieldValue(field, obj);
    }

    String generateIdValue(Field field, Object obj, boolean withUid,UidGenerator uidGenerator) {
