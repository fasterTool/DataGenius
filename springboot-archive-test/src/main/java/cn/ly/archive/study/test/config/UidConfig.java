...
import cn.ly.common.datasource.service.handle.DefaultCrudGeneratorBuilder;
...
//		// 拒绝策略: 当环已满, 无法继续填充时
    ...
    @Bean(name = "defaultCrudGeneratorBuilder")
    public DefaultCrudGeneratorBuilder initDefaultCrudGeneratorBuilder() {
        return new DefaultCrudGeneratorBuilder();
    }


    @Bean(name = "cRUDGeneratorFactory")
    public CRUDGeneratorFactory initGeneratorFactory() {
